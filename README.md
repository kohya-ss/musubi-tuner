...
- LCM inferencing (`--sample_solver lcm` Allows quick, high quality 4 to 8 step inferences when used with LCM models or LoRA! Use 'musubi' version with this repo, a ComfyUI compatible version is also provided for convenience! LoRAs: https://huggingface.co/Blyss/BlissfulModels/tree/main/wan_lcm)
