...
In order to keep this section maintainable as the project grows, each feature will be listed once along with a legend indicating which models in the project currently havee support that feature. Most features pertain to inference, if a feature is available for training that will be specifically noted. Many smaller optimizations and features too numerous to list have been done as well. For the latest updates, I maintain something of a devlog [here](https://github.com/kohya-ss/musubi-tuner/discussions/232)
...
- Load mixed precision transformers (`--mixed_precision_transformer` for inference or training, see https://github.com/kohya-ss/musubi-tuner/discussions/232#discussioncomment-13284677 for how to create such a transformer and why you might wanna) (WV) (T)
