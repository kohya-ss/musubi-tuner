...
- Normalized Attention Guidance (NAG) (https://arxiv.org/pdf/2505.21179) (Provides negative guidance within cross attention layers. Works for distilled models as well as with regular CFG! Enable with `--nag_scale 3.0` and provide a negative prompt!)
