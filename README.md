...
- Optional extra latent noise for I2V/V2V (`--extra_noise 0.02`, values less than 0.04 are recommended. This can improve fine detail and texture in V2V/I2V but too much will cause artifacts and moving shadows. I use around 0.01-0.02 for V2V and 0.02-0.04 for I2V)
