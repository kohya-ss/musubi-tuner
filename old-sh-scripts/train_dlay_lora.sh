#!/bin/bash
# =============================================================================
# DLAY Persona LoRA Training Script for Wan2.2-T2V-A14B
# =============================================================================
...
CACHE_DIR="/root/DATASETS/DLAY/wan_cache"
...
DATASET_CONFIG="${SCRIPT_DIR}/dataset_config_dlay.toml"
SAMPLE_PROMPTS="${SCRIPT_DIR}/sample_prompts_dlay.txt"

# =============================================================================
# STEP 0: Create dataset config and sample prompts
# =============================================================================

echo "============================================="
echo "Step 0: Creating configuration files..."
echo "============================================="
...
accelerate launch --num_cpu_threads_per_process 1 --mixed_precision bf16 \
    ...
    --network_args "loraplus_lr_ratio=${LORAPLUS_LR_RATIO}" \
