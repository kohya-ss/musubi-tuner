...
def draw_bbox_layout(
    ...
    max_bbox_line_width: Optional[int] = None,
    bbox_line_gap: Optional[int] = None,
    return_color: bool = False,
):
    """Draw a black layout image with colored boxes, matching the official layout style."""
...
def create_layout_reference_images(
    ...
    """Create bordered reference images plus one layout image."""
