...
ARCH_KANDINSKY5 = "Kandinsky-5"ARCH_HUNYUAN_VIDEO_1_5 = "hunyuan-video-1.5"
...
def build_metadata(
    ...
    if architecture == ARCHITECTURE_HUNYUAN_VIDEO:
        ...
        impl = IMPL_KANDINSKY5    elif architecture == ARCHITECTURE_LONGCAT:
        arch = CUSTOM_ARCH_LONGCAT
        impl = IMPL_LONGCAT    elif architecture == ARCHITECTURE_HUNYUAN_VIDEO_1_5:
