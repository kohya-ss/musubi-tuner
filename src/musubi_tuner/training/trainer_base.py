...
HunyuanVideo-specific defaults live in the overridable methods (e.g. load_vae,
load_transformer, call_dit). Architectures override those methods in subclasses
defined under each *_train_network.py.
"""
