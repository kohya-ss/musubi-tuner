...
TARGET_REPLACE_MODULES = {
    ...
    ARCHITECTURE_QWEN_IMAGE_EDIT: lora_qwen_image.QWEN_IMAGE_TARGET_REPLACE_MODULES,  # same as QWEN_IMAGE
    ARCHITECTURE_WAN: lora_wan.WAN_TARGET_REPLACE_MODULES,
}
DEFAULT_EXCLUTE_PATTERNS = {
    ARCHITECTURE_FRAMEPACK: [],
    ARCHITECTURE_FLUX_KONTEXT: [],
...
def create_arch_network(
    ...
    **kwargs,
    ...
    exclude_patterns.extend(DEFAULT_EXCLUTE_PATTERNS.get(architecture, []))
