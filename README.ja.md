...
- LCM 推論 (`--sample_solver lcm` を使用すると、LCM モデルまたは LoRA と組み合わせて使用​​すると、4 ～ 8 ステップの高速で高品質な推論が可能になります。このリポジトリでは 'blissful' バージョンを使用してください。利便性のために ComfyUI 互換バージョンも提供されています。LoRA: https://huggingface.co/Blyss/BlissfulModels/tree/main/wan_lcm)
